...
{
    public class WindowsEmbeddedSignatureVerifier : EmbeddedSignatureVerifier
    {
        ...
        private sealed class WINTRUST_DATA
        {
            ...
            internal ProviderFlags dwProvFlags = ProviderFlags.WTD_REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT | ProviderFlags.WTD_DISABLE_MD2_MD4;
