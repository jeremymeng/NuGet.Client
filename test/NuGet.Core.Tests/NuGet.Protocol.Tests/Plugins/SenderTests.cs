    ...
    public class SenderTests
    {
        ...
        public void Constructor_ThrowsForNull()
        {
            var exception = Assert.Throws<ArgumentNullException>(
                () => new Sender(writer: null, globalCancellationToken: CancellationToken.None));
        ...
        [Fact]
        public void Constructor_DoesNotThrowIfCancelled()
        {
            new Sender(TextWriter.Null, new CancellationToken(canceled: true));
        }
        ...
        public void Dispose_ClosesUnderlyingStream()
        {
            ...
            using (var writer = new StreamWriter(stream))
            {
                ...
                var sender = new Sender(writer, CancellationToken.None);
        ...
        {
            var sender = new Sender(TextWriter.Null, CancellationToken.None);
        ...
        public async Task SendAsync_BlocksIfNotConnected()
        {
            ...
            using (var sender = new Sender(TextWriter.Null, cancellationTokenSource.Token))
            {
        ...
        public async Task SendAsync_ThrowsForDisposedWriter()
        {
            using (var writer = new StringWriter())
            {
                ...
                using (var sender = new Sender(writer, CancellationToken.None))
                {
                    await sender.ConnectAsync(CancellationToken.None);
