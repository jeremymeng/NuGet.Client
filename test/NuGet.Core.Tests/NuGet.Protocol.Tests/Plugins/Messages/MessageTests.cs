...
namespace NuGet.Protocol.Plugins.Tests
{
    public class MessageTests
    {
        ...
        public void Constructor_ThrowsForUndefinedMethod(int method)
        {
            var exception = Assert.Throws<ArgumentException>(() => new Message("requestId", MessageType.Fault, (MessageMethod)method));
        ...
        public void JsonSerialization_ReturnsCorrectJson()
        {
            ...
            var message = new Message(requestId: "a", type: MessageType.Request, method: MessageMethod.None, payload: payload);
        ...
        public void JsonDeserialization_ReturnsCorrectObject()
        {
            ...
            var message = TestUtilities.Deserialize<Message>(json);
        ...
        {
            Assert.Throws<ArgumentException>(() => TestUtilities.Deserialize<Message>(json));
        }
        ...
        {
            Assert.Throws<JsonSerializationException>(() => TestUtilities.Deserialize<Message>(json));
        }
        ...
        public void JsonDeserialization_ThrowsForPayloadParseError()
        {
            ...
            Assert.Throws<JsonReaderException>(() => TestUtilities.Deserialize<Message>(json));
        }
