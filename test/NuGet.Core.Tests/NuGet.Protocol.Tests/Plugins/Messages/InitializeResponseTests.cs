...
namespace NuGet.Protocol.Plugins.Tests
{
    public class InitializeResponseTests
    {
        ...
        {
            var response = TestUtilities.Deserialize<InitializeResponse>(json);
        ...
        {
            Assert.Throws<JsonSerializationException>(() => TestUtilities.Deserialize<InitializeResponse>(json));
        }
    }
}